var menuState = {
    ...
    create: function () {
        ...
        nameTween.to({y: 80}, 1000).easing(Phaser.Easing.Bounce.Out).start();
        
        // Add score local storage
        ...
        var startLabelTween = game.add.tween(startLabel);
        startLabelTween.to({angle: -2}, 500).to({angle: 2}, 500).loop().start();
        
        var upKey = game.input.keyboard.addKey(Phaser.Keyboard.UP);
        upKey.onDown.addOnce(this.start, this);
        
        // Add mute sound button
